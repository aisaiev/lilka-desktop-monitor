...
per-pixel updates to the Lilka receiver using the same pixel-update protocol.
"""
...
DEFAULT_PORT = 8090
DISPLAY_WIDTH = 280 # Lilka display width
DISPLAY_HEIGHT = 240 # Lilka display height
